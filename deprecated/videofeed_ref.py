...
class Application:
    def __init__(self, output_path="./"):
        ...
        self.root.title(
            "     LA  SELVA - REMOT VIDEO SNAP SHOT     "
        )  # set window title
        ...
        self.botMail = tk.Button(
            self.root,
            width=25,
            font=("arial", 12, "normal"),
            text="SEND PICTURE BY MAIL",
